        	...
        	<div class="card">
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 ...
						 <p>Available Seats (economy) : <b><h4><?php echo $row['seats_economy'] - $booked ?></h4></b></p>
						 <p>Available Seats (business) : <b><h4><?php echo $row['seats_business'] - $booked ?></h4></b></p>
						 <p>Available Seats (first class) : <b><h4><?php echo $row['seats_first_class'] - $booked ?></h4></b></p>
					</div>
					<div class="col-md-3 text-center align-self-end-sm">
						<h4 class="text-right"><b><?php echo number_format($row['price'],2) ?></b></h4>
						<button class="btn-outline-primary  btn  mb-4 book_flight" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo $aname[$row['departure_airport_id']].' - '.$aname[$row['arrival_airport_id']] ?>" data-max="<?php echo $row['seats_economy'] + $row['seats_business'] + $row['seats_first_class'] - $booked ?>">Book Now</button>
					</div>
				</div>
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 ...
						 <p><small>Departure: <b><?php echo date('h:i A',strtotime($row['departure_datetime'])) ?></b></small></p>
						 <p><small>Arrival: <b><?php echo (date('M d,Y',strtotime($row['departure_datetime'])) == date('M d,Y',strtotime($row['arrival_datetime']))) ? date('h:i A',strtotime($row['arrival_datetime'])) : date('M d,Y h:i A',strtotime($row['arrival_datetime'])) ?></b></small></p>
						 <p><small>Return: <b><?php echo (date('M d,Y',strtotime($row['departure_datetime'])) == date('M d,Y',strtotime($row['arrival_datetime']))) ? date('h:i A',strtotime($row['arrival_datetime'])) : date('M d,Y h:i A',strtotime($row['return_datetime'])) ?></b></small></p>
